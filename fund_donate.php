                            ...
                            <ul class="sf-menu" id="fh5co-primary-menu">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="fh5co-sub-menu">
                                        <li class="active"><a href="donate_page.php">Donate</a></li>
                ...
                <div class="modal-content">
                    ...
                    if (isset($_POST['save'])) {
                        ...
                        if ($_SESSION['email'] != null &&  $_SESSION['password'] != null) {
                            ...
                            $run_donation = mysqli_query($con, "insert into donations (payment_method,mobile_number,trxid,amount,volunteer_id,fund_id) 
                            values ('$payment_method','$mobile_number','$trxid','$amount','$volunteer_id','$fund_id')");
                        } else {
                            $run_donation = mysqli_query($con, "insert into donations (payment_method,mobile_number,trxid,amount,fund_id) 
                            values ('$payment_method','$mobile_number','$trxid','$amount','$fund_id')");
                        }
                        if ($run_donation) {
