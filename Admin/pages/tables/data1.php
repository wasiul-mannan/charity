        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="treeview active"><a href="../tables/data1.php"><i class="fa fa-circle-o"></i> Volunteer tables</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                    $total_amount = 0;
                    $run_donation = mysqli_query($con, "select * from volunteer ");
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row_run_donation['address']; ?></td>
                        <td><a href="delete_volunteer.php?delete_id=<?php echo $id; ?>">
