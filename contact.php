...
if (isset($_POST['send_msg'])) {
	...
	$run_contact = mysqli_query($con, "insert into contact (name,email,message) 
						...
						<div class="row">
							<div class="col-md-6">
								...
								<ul class="contact-info">
									<li><i class="icon-location-pin"></i>CHILDREN Charity, House #57 Road #7/B, Block <div id="H">Banani, 1213,Dhaka Bangladesh</div>
									</li>
