                            ...
                            <form style="padding-bottom: 10%;" method="POST">
                                <nav id="fh5co-menu-wrap" role="navigation">
                                    <ul style="display: flex; justify-content: center;">
                                        ...
                                        <li>
                                            <button type="submit" class="btn btn-primary" name="profile">Profile</button>
                                        </li>
                    ...
                    <div class="row row-bottom-padded-md">
                        ...
                        ?>
                                <form style="padding-bottom: 10%;" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" rows="3" class="form-control" name="name">
                                    </div>

                                    <div class="form-group">
                                        <label for="pwd">Mobile No</label>
                                        <input type="text" rows="3" class="form-control" name="mobile">
                                    </div>

                                    <div class="form-group">
                                        <label for="pwd">Email</label>
                                        <input type="text" rows="3" class="form-control" name="email" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" rows="3" class="form-control" name="password" required>
                                    </div>

                                    <div class="row">
                                        <div style="padding-top: 3%;" class="col-md-4 col-md-offset-4 text-center animate-box">
                                            <button type="submit" class="btn btn-primary btn-lg" name="register_data">Register</button>
                                        </div>
                                    </div>
                        ...
                        if (!isset($_SESSION['email'])) {
                            if (isset($_POST['login_data'])) {
                                ...
                                $run_v_login = mysqli_query($con, "select * from volunteer where email='$email' and password='$password' ");
                                $row_run_v_login = mysqli_fetch_array($run_v_login);
                                if (isset($row_run_v_login)) {
                        ...
                        ?>
                                <form style="padding-bottom: 10%;" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="pwd">Email</label>
                                        <input type="text" rows="3" class="form-control" name="email">
                                    </div>

                                    <div class="form-group">
                                        <label for="pwd">Password</label>
                                        <input type="password" rows="3" class="form-control" name="password">
                                    </div>

                                    <div class="row">
                                        <div style="padding-top: 3%;" class="col-md-4 col-md-offset-4 text-center animate-box">
                                            <button type="submit" class="btn btn-primary btn-lg" name="login_data">Login</button>
                                        </div>
                                    </div>
                        ...
                        if (isset($_SESSION['email'])) {
                            if (isset($_POST['profile'])) {
                                ...
                                $run_v_data = mysqli_query($con, "select * from volunteer where email='$email' and password='$password' ");
                                $row_run_v_data = mysqli_fetch_array($run_v_data);
                        ?>
                                <div class="form-group">
                                    <label for="pwd">Name</label>
                                    <input type="text" rows="3" class="form-control" name="name" value="<?php echo $row_run_v_data['name']; ?>" disabled>
                                </div>

                                <div class="form-group">
                                    <label for="pwd">Mobile No</label>
                                    <input type="text" rows="3" class="form-control" name="mobile" value="<?php echo $row_run_v_data['mobile']; ?>" disabled>
                                </div>

                                <div class="form-group">
                                    <label for="pwd">Email</label>
                                    <input type="text" rows="3" class="form-control" name="email" value="<?php echo $row_run_v_data['email']; ?>" disabled>
                                </div>

                                <div class="form-group">
                                    <label for="pwd">Address</label>
                                    <textarea type="text" rows="3" class="form-control" name="address" disabled><?php echo $row_run_v_data['address']; ?></textarea>
                                </div>
                        <?php
                            }
                        }
                        ...
                        ?>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <?php
                                    $run_v_donation = mysqli_query($con, "select * from donations where volunteer_id='$v_id' ");
                                    while ($row_run_v_donation = mysqli_fetch_array($run_v_donation)) {
                                    ?>
                                        <tbody>

                                            <td><?php echo $row_run_v_donation['date_created']; ?></td>
                                            <td><?php echo $row_run_v_donation['payment_method']; ?></td>
                                            <td><?php echo $row_run_v_donation['amount']; ?></td>
                                    ...
                                    <?php
                                    $run_v_donation = mysqli_query($con, "select * from funds where volunteer_id='$v_id' ");
                                    while ($row_run_v_donation = mysqli_fetch_array($run_v_donation)) {
                                    ?>
                                        <tbody>

                                            <td><?php echo $row_run_v_donation['date_created']; ?></td>
                                            <td><?php echo $row_run_v_donation['title']; ?></td>
                                            <td><?php echo $row_run_v_donation['amount']; ?></td>
